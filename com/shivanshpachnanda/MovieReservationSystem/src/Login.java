...
class Login extends JLabel implements ActionListener,FocusListener{
	...
	Login(){
			...
			this.setOpaque(true);
			this.setBounds(100,300,400,250);
			this.setHorizontalAlignment(JLabel.CENTER);
			this.setLayout(null);
			
			JLabel Title = new JLabel("WELCOME!");
			Title.setForeground(new Color(188,188,188,255));
			...
			userName.setBounds(10,55,360,45);
			...
			userText.setBounds(10,90,350,25);
			...
			passWord.setForeground(new Color(188,188,188,255));
			passWord.setBounds(10, 125, 360, 45);
			...
			correction.setBounds(10,220,390,45);
